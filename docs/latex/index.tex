...
The API gets the configurations from a folder named {\ttfamily configs}. The configurations are in {\ttfamily XML} format.
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ "{}Test"{}:\ \{}
\DoxyCodeLine{\ \ \ \ "{}Provision"{}:\ \{\ "{}ProvisionNumber"{}:\ 12345678901234,\ "{}CostApproval"{}:\ true\ \},}
\DoxyCodeLine{\ \ \ \ "{}TypeOfProvision"{}:\ "{}123e4567-\/e89b-\/12d3-\/a456-\/526614174000"{},}
\DoxyCodeLine{\ \ \ \ "{}Profession"{}:\ "{}123e4567-\/e89b-\/12d3-\/a456-\/226614174000"{},}
\DoxyCodeLine{\ \ \ \ "{}SalaryType"{}:\ "{}123e4567-\/e89b-\/12d3-\/a456-\/426614174000"{},}
\DoxyCodeLine{\ \ \ \ "{}DateFrom"{}:\ "{}2020-\/01-\/01"{},}
\DoxyCodeLine{\ \ \ \ "{}DateTo"{}:\ "{}2020-\/12-\/31"{},}
\DoxyCodeLine{\ \ \ \ "{}InsuranceProductConfig"{}:\ \{}
\DoxyCodeLine{\ \ \ \ \ \ "{}TarifNumber"{}:\ 1234567,}
\DoxyCodeLine{\ \ \ \ \ \ "{}BillingCategory"{}:\ "{}Test"{},}
\DoxyCodeLine{\ \ \ \ \ \ "{}Price"{}:\ 123.45,}
\DoxyCodeLine{\ \ \ \ \ \ "{}Units"{}:\ 3}
\DoxyCodeLine{\ \ \ \ \},}
\DoxyCodeLine{\ \ \ \ "{}Institution"{}:\ "{}"{},}
\DoxyCodeLine{\ \ \ \ "{}Schule"{}:\ "{}Test"{},}
\DoxyCodeLine{\ \ \ \ "{}LehrgangsBezeichnung"{}:\ "{}123e4567-\/e89b-\/12d3-\/a456-\/426614174000"{},}
\DoxyCodeLine{\ \ \ \ "{}Ort"{}:\ "{}"{}}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\}}
...
Connect to the API (can be done with Netcat or Telnet). The incoming data, that has to be validated, must be in {\ttfamily JSON} format\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{telnet\ 127.0.0.1\ 8080}
